...
//                        .append(" must be greater than ").append(number);
//                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
//                        defaultEnglishMessage.toString(), this.parameter, StringValue, number);
//                this.dataValidationErrors.add(error);
//            }
//        }
//        return this;
//    }
//
//    public DataValidatorBuilder longGreaterThanNumber(String paramName, String number, int index) {
//        if (this.value == null && this.ignoreNullValue) { return this; }
//
//        if (this.value != null) {
//            final Long longValue = Long.valueOf(this.value.toString());
